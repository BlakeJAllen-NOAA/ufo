...
integer, parameter, public :: n_aerosols_gocart_default=14,&
     ...
     &n_aerosols_gocart_geos=18,n_aerosols_gocart_rrfs=3 !soon 21 for geos
...
character(len=MAXVARLEN), public, parameter :: var_ps     = "air_pressure_at_surface"
character(len=MAXVARLEN), public, parameter :: var_pmsl   = "air_pressure_at_sea_level" ! used by MetOffice opsinputs
...
character(len=MAXVARLEN), public, parameter :: var_sfc_z  = "geopotential_height_at_surface"
...
character(len=MAXVARLEN), public, parameter :: var_sfc_wdir    = "wind_from_direction_at_surface"
character(len=MAXVARLEN), public, parameter :: var_sfc_u10     = "eastward_wind_at_10m"
character(len=MAXVARLEN), public, parameter :: var_sfc_v10     = "northward_wind_at_10m"
character(len=MAXVARLEN), public, parameter :: var_sfc_u       = "eastward_wind_at_surface"
character(len=MAXVARLEN), public, parameter :: var_sfc_v       = "northward_wind_at_surface"
...
character(len=MAXVARLEN), public, parameter :: var_dutest = "mass_fraction_of_dust001_in_air"
...
character(len=MAXVARLEN), public, parameter :: var_du005 = "mixing_ratio_of_coarsepm_wrt_dry_air"
...
character(len=maxvarlen), dimension(n_aerosols_gocart_rrfs), public, parameter :: &
     &var_aerosols_gocart_rrfs = [var_ocphobic, var_du001, var_du005]
